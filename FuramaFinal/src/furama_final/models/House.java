...
public class House extends Facility {
    ...
    public House(String idService,String serviceName, int usableArea, int rentalCosts, int numberOfPeople, String rentalType, String styleStandard, int numberOfFloors) {
